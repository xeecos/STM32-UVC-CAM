...
async function transfer()
{
    ...
    web.transferOut(2,Buffer.from([1,1,0x0,0x0,0,0,imageWidth>>8,imageWidth&0xff,imageHeight>>8,imageHeight&0xff])).then((res)=>{
        console.log(res);
    });
    ...
    web.transferOut(2,Buffer.from([1,7,0x2])).then((res)=>{
        console.log(res);
    });
